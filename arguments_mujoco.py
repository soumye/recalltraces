...
def achieve_arguments():
    ...
    parse.add_argument('--trace-size', type=int, default=3, help='Number of steps to backtrack on for a given high value state ie length of trajectory')
    ...
    parse.add_argument('--n-bw', type=int, default=20, help='Number of bw updates to do per n-a2c updates')
    parse.add_argument('--n-imi', type=int, default=1, help='Number of imitation updates to do per n-a2c updates')
