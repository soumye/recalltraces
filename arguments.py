...
def achieve_arguments():
    ...
    parse.add_argument('--num-processes', type=int, default=32, help='the number of cpu you use')
    ...
    parse.add_argument('--capacity', type=int, default=10000, help='the capacity of the replay buffer')
